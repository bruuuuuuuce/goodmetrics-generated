...
Before pushing to an existing branch name — especially one you're treating as "add a commit to an
already-open PR" — verify it's actually still open first (e.g. `gh pr view <number> --json
